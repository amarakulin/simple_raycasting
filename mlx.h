...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/12/30 19:03:51 by tilda             #+#    #+#             */
/*   Updated: 2020/12/30 19:03:54 by tilda            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
**  x and y must fit into the size of the window, no control is done
** on the values
*/
...
/*
**  Usually asked...
**   mlx_string_put display may vary in size between OS and
** between mlx implementations
*/
